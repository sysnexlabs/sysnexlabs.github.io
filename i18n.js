const translations = {
  en: {
    ...
    'nav.process': 'Process',
    'nav.contact': 'Contact',
    'hero.kicker': 'Integrated Mobility Systems',
    'hero.headline': 'Model-Based Systems Engineering, Reinvented',
    'hero.paragraph': 'We orchestrate SysML v2, AI, and Rust-built tooling to harmonise air, road, and space platforms. Deliver functional safety, traceability, and real-time insight across every program milestone.',
    ...
    'hero.insights.aerial.eyebrow': 'Autonomous Flight',
    'hero.insights.aerial.title': 'Federated digital twin for DO-178C',
    'hero.insights.aerial.body': '72% faster certification cycles with executable SysML v2, thermal situational awareness, and mission rehearsal pipelines.',
    'hero.insights.mobility.eyebrow': 'Connected EV Platforms',
    'hero.insights.mobility.title': 'ISO 26262 compliant software-defined vehicle',
    'hero.insights.mobility.body': 'Edge-to-cloud orchestration, resilient OTA updates, and Git-native model traceability for your safety case.',
    'hero.insights.infrastructure.eyebrow': 'Mission Ops',
    'hero.insights.infrastructure.title': '24/7 model observability across the digital thread',
    'hero.insights.infrastructure.body': 'Executable specs feed simulation, code, and test benches so every anomaly is traced, triaged, and resolved in hours.',
    ...
    'features.item1.body': 'Rust-based SysML v2 LSP, textual modeling, Git integration, and IDE-native workflows.',
    'features.item2.title': 'MBSE Methodology',
    'features.item2.body': 'From use case to architecture: practical SysML v2 methods, traceability, and evaluation.',
    'features.item3.title': 'AI × Models',
    'features.item3.body': 'Assisted generation, exploration, and consistency checks for models and requirements.',
